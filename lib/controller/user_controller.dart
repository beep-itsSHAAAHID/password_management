    ...
    if (email != null) {
      try {
        ...
        final userDoc = await FirebaseFirestore.instance
            ...
            .get();
        final fullName =
            userDoc.data()?['fullName'] as String?; // Get the fullName field

        if (fullName != null) {
          userName.value =
              fullName; // Update the userName observable with the fetched name
        } else {
          // Handle the case where fullName is null or missing
          print("FullName is null or not found in the document.");
          userName.value =
              "User"; // Optionally set a default value or handle as needed
        }
      } catch (e) {
